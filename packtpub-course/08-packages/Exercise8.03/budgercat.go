...
// init carga antes que el main,uselo para inicializacin o incluso dependency injection
func init() {
...
// ejemplo de multiples init, sejecutan en el order en que vienen los inits de arrriba hacia abajo del
// archivo .go
func init() {
